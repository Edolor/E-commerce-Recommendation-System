import "./_footer.scss";
// import logo from "../../Assets/images/full_logo.jpg"; Removed for copyright infringements
            ...
            <div className="width-wrapper">
                <div className="footer__wrapper">
                    <div className="footer__left">
                        <Link to="/">
                            <figure className="footer__image color-white">
                                {/* <img src={logo} alt="Random full logo" /> */}
                                Full Logo
                                <figcaption className="hide">Full logo</figcaption>
                            </figure>
                        </Link>

                        <p className="margin-top-2 body-copy--big color-white">©2022, THE Random LLC</p>
                    </div>
                    ...
                    <nav className="footer__right">
                        ...
                        <div className="footer__container">
                            ...
                            <ul className="footer__list list-s-none">
                                <li className="footer__item"><a href="/" className="footer__link">sample@sample.com</a></li>
